...
import com.nuclearmekanism.nuclearentangloporter.content.chemical.RadioactiveChemicalTank;
...
/** Mekanism chemical tank logic with its storage validator replaced by {@link RadioactiveChemicalTank}. */
public class TileEntityRadioactiveChemicalTank extends TileEntityConfigurableMachine implements IHasGasMode {
    ...
    public TileEntityRadioactiveChemicalTank(Holder<Block> block, BlockPos pos, BlockState state) {
    ...
    public @Nullable IChemicalTankHolder getInitialChemicalTanks(IContentsListener listener) {
        ...
        builder.addTank(chemicalTank = RadioactiveChemicalTank.create(tier, listener));
    ...
    public void parseUpgradeData(HolderLookup.Provider provider, @NotNull IUpgradeData upgradeData) {
        if (upgradeData instanceof ChemicalTankUpgradeData data) {
            ...
            chemicalTank.setStack(data.storedChemical);
    ...
    public ChemicalTankUpgradeData getUpgradeData(HolderLookup.Provider provider) {
        return new ChemicalTankUpgradeData(provider, redstone, getControlType(), drainSlot, fillSlot, dumping, chemicalTank.getStack(), getComponents());
    }

    @Override
    public void writeSustainedData(HolderLookup.Provider provider, CompoundTag data) {
        super.writeSustainedData(provider, data);
        NBTUtils.writeEnum(data, SerializationConstants.DUMP_MODE, dumping);
    }
